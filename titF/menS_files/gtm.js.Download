...
"resource": {
  ...
  "tags":[{
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003Evar typeHorizontalAds=\"carbonAds\",typeSquareAds=\"carbonAds\",adParams={adType:\"dynamic\",imageUrl:\"https:\/\/files.slack.com\/files-pri\/T0B5D49AB-FJXDMB9AP\/image.png\",adUrl:\"https:\/\/sympli.io?utm_source\\x3dicons8\\x26utm_medium\\x3dbanner\\x26utm_campaign\\x3dversioncontrol_handof\",isFallback:!1,styles:{width:\"680px\",height:\"93px\",backgroundColor:\"#1571f1\",bannerIllustrationUrl:\"https:\/\/puu.sh\/DE4Do\/7ee1e5212c.png\",ctaColor:\"#eb4329\",mainText:\"Design version control \\x26 handoff\",mainTextColor:\"#FFFFFF\",ctaText:\"Try for Free\",\nctaTextColor:\"#FFFFFF\"}};\u003C\/script\u003E\n\n",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":18
  ...
  "rules":[
    [["if",1],["unless",0],["add",0,2,9]],
    [["if",1],["unless",2],["add",1,30,31,35]],
    [["if",1],["unless",3,4],["add",3]],
    [["if",1],["unless",4,5],["add",4]],
    [["if",1],["unless",0,6,7],["add",5]],
    [["if",1],["add",6,28,48,46,49]],
    [["if",1,8],["add",7]],
    [["if",1,9],["add",8,23,44]],
    [["if",1],["unless",6,7,9],["add",10]],
    [["if",1,10],["add",11,24]],
    [["if",1],["unless",6,11],["add",12]],
    [["if",1],["unless",7,12,13],["add",13]],
    [["if",1,14],["add",14]],
    [["if",1],["unless",15,16],["add",15]],
    [["if",1,15],["add",16]],
    [["if",1],["unless",11,17,18],["add",17]],
    [["if",1,17],["add",18]],
    [["if",1,2],["unless",6],["add",19,21,25,50]],
    [["if",1],["unless",2,6],["add",20,26,29,32,36,37,38,39,40,42,43]],
    [["if",1],["unless",2,6,9],["add",22]],
    [["if",1,19],["add",27]],
    [["if",1,20],["add",33]],
    [["if",1,2,21],["add",34]],
    [["if",1],["unless",2,9],["add",41]],
    [["if",22],["add",45]],
    [["if",1],["unless",2,23,24,25,26],["add",47]]]
},
"runtime":[]
...
return null},Hd=!1;if(H.querySelectorAll)try{var Id=H.querySelectorAll(":root");Id&&1==Id.length&&Id[0]==H.documentElement&&(Hd=!0)}catch(a){}var Dd=Hd;var Wd={},L=null,Xd=Math.random();Wd.B="GTM-5W9QXH7";Wd.hc="b41";Wd.gi="";var Yd={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0},Zd={__paused:!0,__tg:!0},$d;for($d in Yd)Yd.hasOwnProperty($d)&&(Zd[$d]=!0);var ae="www.googletagmanager.com/gtm.js";
var be=ae,ce=Ja(""),de=null,ee=null,fe="//www.googletagmanager.com/a?id="+Wd.B+"&cv=194",ge={},he={},ie=function(){var a=L.sequence||1;L.sequence=a+1;return a};var je={},ke=new Ea,le={},me={},pe={name:"GTMDataLayer",set:function(a,b){m(Ua(a,b),le);ne()},get:function(a){return oe(a,2)},reset:function(){ke=new Ea;le={};ne()}},oe=function(a,b){return 2!=b?ke.get(a):qe(a)},qe=function(a){var b,c=a.split(".");b=b||[];for(var d=le,e=0;e<c.length;e++){if(null===d)return!1;if(void 0===d)break;d=d[c[e]];if(-1!==Ba(b,d))return}return d},re=function(a,b){me.hasOwnProperty(a)||(ke.set(a,b),m(Ua(a,b),le),ne())},ne=function(a){Ha(me,function(b,c){ke.set(b,c);m(Ua(b,
...
return!a}function Cl(){var a=Bl();try{bl(G["GTMDataLayer"],Wd.B)}catch(b){}return a}
var El=function(){var a=Vc("GTMDataLayer",[]),b=Vc("google_tag_manager",{});b=b["GTMDataLayer"]=b["GTMDataLayer"]||{};bh(function(){b.gtmDom||(b.gtmDom=!0,a.push({event:"gtm.dom"}))});Rk(function(){b.gtmLoad||(b.gtmLoad=!0,a.push({event:"gtm.load"}))});b.subscribers=(b.subscribers||0)+1;var c=a.push;a.push=function(){var e;if(0<L.SANDBOXED_JS_SEMAPHORE){e=[];for(var f=0;f<arguments.length;f++)e[f]=new vl(arguments[f])}else e=[].slice.call(arguments,0);var h=c.apply(a,e);wl.push.apply(wl,e);if(300<
...
Y.a.f=["google"],function(){(function(a){Y.__f=a;Y.__f.b="f";Y.__f.g=!0;Y.__f.priorityOverride=0})(function(a){var b=lm("gtm.referrer",1)||H.referrer;return b?a.vtp_component&&"URL"!=a.vtp_component?De(Fe(String(b)),a.vtp_component,a.vtp_stripWww,a.vtp_defaultPages,a.vtp_queryKey):km(String(b)):String(b)})}();
...
Y.a.gas=["google"],function(){(function(a){Y.__gas=a;Y.__gas.b="gas";Y.__gas.g=!0;Y.__gas.priorityOverride=0})(function(a){var b=m(a),c=b;c[Ob.Ia]=null;c[Ob.ig]=null;var d=b=c;d.vtp_fieldsToSet=d.vtp_fieldsToSet||[];var e=d.vtp_cookieDomain;void 0!==e&&(d.vtp_fieldsToSet.push({fieldName:"cookieDomain",value:e}),delete d.vtp_cookieDomain);return b})}();
Y.a.hl=["google"],function(){function a(f){return f.target&&f.target.location&&f.target.location.href?f.target.location.href:im()}function b(f,h){ad(f,"hashchange",function(k){var l=a(k);h({source:"hashchange",state:null,url:km(l),R:jm(l)})})}function c(f,h){ad(f,"popstate",function(k){var l=a(k);h({source:"popstate",state:k.state,url:km(l),R:jm(l)})})}function d(f,h,k){var l=h.history,q=l[f];if(ya(q))try{l[f]=function(r,p,t){q.apply(l,[].slice.call(arguments,0));k({source:f,state:r,url:km(im()),
R:jm(im())})}}catch(r){}}function e(){var f={source:null,state:V("history").state||null,url:km(im()),R:jm(im())};return function(h){var k=f,l={};l[k.source]=!0;l[h.source]=!0;if(!l.popstate||!l.hashchange||k.R!=h.R){var q={event:"gtm.historyChange","gtm.historyChangeSource":h.source,"gtm.oldUrlFragment":f.R,"gtm.newUrlFragment":h.R,"gtm.oldHistoryState":f.state,"gtm.newHistoryState":h.state,"gtm.oldUrl":f.url,"gtm.newUrl":h.url};f=h;mm(q)}}}(function(f){Y.__hl=f;Y.__hl.b="hl";Y.__hl.g=!0;Y.__hl.priorityOverride=
0})(function(f){var h=V("self");if(!rm("hl")){var k=e();b(h,k);c(h,k);d("pushState",h,k);d("replaceState",h,k);sm("hl")}I(f.vtp_gtmOnSuccess)})}();
...
Y.a.html=["customScripts"],function(){function a(d,e,f,h){return function(){try{if(0<e.length){var k=e.shift(),l=a(d,e,f,h);if("SCRIPT"==String(k.nodeName).toUpperCase()&&"text/gtmscript"==k.type){var q=H.createElement("script");q.async=!1;q.type="text/javascript";q.id=k.id;q.text=k.text||k.textContent||k.innerHTML||"";k.charset&&(q.charset=k.charset);var r=k.getAttribute("data-gtmsrc");r&&(q.src=r,Wc(q,l));d.insertBefore(q,null);r||l()}else if(k.innerHTML&&0<=k.innerHTML.toLowerCase().indexOf("<script")){for(var p=
[];k.firstChild;)p.push(k.removeChild(k.firstChild));d.insertBefore(k,null);a(k,p,l,h)()}else d.insertBefore(k,null),l()}else f()}catch(t){I(h)}}}var c=function(d){if(H.body){var e=d.vtp_gtmOnFailure,f=wm(d.vtp_html,d.vtp_gtmOnSuccess,
e),h=f.od,k=f.H;if(d.vtp_useIframe){}else d.vtp_supportDocumentWrite?b(h,k,e):a(H.body,ed(h),k,e)()}else gm(function(){c(d)},200)};Y.__html=c;Y.__html.b="html";Y.__html.g=
...
(function(a){var e=!0;
e=!1;if(e){a();return}var f=function(){var q=G["google.tagmanager.debugui2.queue"];q||(q=[],G["google.tagmanager.debugui2.queue"]=q,Xc("https://www.googletagmanager.com/debug/bootstrap"));return q},h="x"===De(G.location,"query",
